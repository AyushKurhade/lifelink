...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _showDonorAlert({
    ...
    switch (urgency) {
      case 'Critical':
        urgencyColor = const Color(0xFFA32D2D);
        break;
      case 'Urgent':
        urgencyColor = const Color(0xFFBA7517);
        break;
      default:
        urgencyColor = const Color(0xFF3B6D11);
    }
          ...
          children: [
            ...
            Container(
              ...
              child: const Icon(Icons.bloodtype,
                  color: Color(0xFFA32D2D), size: 36),
            ),
            const SizedBox(height: 16),
            const Text('Blood Request Arrived!',
                style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.w800,
                    color: Color(0xFF111111))),
            const SizedBox(height: 6),
            const Text('A patient nearby needs your help urgently',
                ...
                Expanded(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      Get.snackbar(
                        '✅ Request Accepted!',
                        'Thank you! Please proceed to the patient location.',
    ...
    ).whenComplete(() => _popupShown = false);
  }
